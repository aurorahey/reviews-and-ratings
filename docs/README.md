...
> ℹ️ _If you have already installed  `vtex.reviews-and-ratings@2.x` **you have to migrate the reviews to master data** by making this `GET` call: `https://{accountName}.{environment}.com/reviews-and-ratings/migrate-data`, after that you can uninstall the version 2 by runing the following command: `vtex uninstall vtex.reviews-and-ratings@2.x`_
